...
assert.match(html, /Большая семейка/);
assert.match(html, /Кум Азазель/);
assert.match(html, /Баба Яга/);
assert.ok(html.includes(`${prefix}/game/kum-azazel.png`));
assert.ok(html.includes(`${prefix}/game/baba-yaga.png`));
